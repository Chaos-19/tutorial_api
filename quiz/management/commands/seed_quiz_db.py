...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Quiz data (previously quiz_courses_data)
        quiz_data = [
        ...
        for data in quiz_data:
            # Upload the quiz icon to Cloudinary
            ...
            # Create a Quiz directly linked to Tutorial
            quiz = Quiz(
            ...
            # Load and process the corresponding quiz JSON file
